...
def find(exception):
    # проход по исключениям от которых наследуется
    for element in dict_exception[exception]:
        # index для проверки элементов выше данного
        if element in lst[0: index] or find(element):
            return True
    return False
...
for i in range(int(input())):
    ...
    dict_exception[str_input[0]] = str_input[2:]
